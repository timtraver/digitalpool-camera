...
createSliderControl('exposure_absolute', 'exposureAbsolute', 'exposureAbsoluteValue');
createSliderControl('gain', 'gain', 'gainValue');
createSliderControl('backlight_compensation', 'backlightCompensation', 'backlightCompensationValue');

// White Balance Controls
document.getElementById('whiteBalanceAuto').addEventListener('change', (e) => {
    const value = e.target.checked ? 1 : 0;
    socket.emit('setControl', { control: 'white_balance_temperature_auto', value: value });
});

createSliderControl('white_balance_temperature', 'whiteBalanceTemp', 'whiteBalanceTempValue');
